...
const AddPostButton = ({isWhite, style, navigation}) => (
  <TouchableOpacity style={[styles.button, style]} onPress={() => navigation.navigate('Add Post')}>
    <Icon
      family="entypo"
      size={16}
      name="add-to-list"
...
class Header extends React.Component {
  ...
  renderRight = () => {
    ...
    switch (title) {
      case 'Home':
        return ([
          <AddPostButton key='chat-home' navigation={navigation} isWhite={white} />,
